        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Admin/PengajuanMasuk') ?>" class="nav-link <?= $menu == 'pengajuanmasuk' ? 'active' : '' ?>">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Admin/PengajuanDiterima') ?>" class="nav-link <?= $menu == 'pengajuanditerima' ? 'active' : '' ?>">
                            <i class="far fa-circle nav-icon"></i>
                                <p>Diterima</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Admin/PengajuanDitolak') ?>" class="nav-link <?= $menu == 'pengajuanditolak' ? 'active' : '' ?>">
                            <i class="far fa-circle nav-icon"></i>
                                <p>Ditolak</p>
                            </a>
                        </li>
