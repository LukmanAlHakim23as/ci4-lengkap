            ...
            <div class="col-sm-10">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="halaman" value="<?= old('halaman') ?>" placeholder="Jumlah Halaman">
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="jumlah" value="<?= old('jumlah') ?>" placeholder="Jumlah Buku">
                    </div>
                </div>
